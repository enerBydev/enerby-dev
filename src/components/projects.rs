...
pub fn get_projects() -> Vec<Project> {
    vec![
        ...
        Project {
            id: "oc-diagdoc",
            title: "oc_diagdoc",
            description: "Motor de diagnóstico documental de alto rendimiento escrito en Rust. 21 fases de análisis y auto-reparación.",
        ...
        Project {
            ...
            technologies: vec!["Nuxt 3", "Vue.js", "AI", "TypeScript"],
